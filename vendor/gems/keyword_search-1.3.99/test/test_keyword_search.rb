...
context "KeywordSearch" do
  ...
  specify "doesn't explode when given leading whitespace" do
    assert_nothing_raised do
      KeywordSearch.search("  blah")
    end
  end
  
  specify "doesn't explode when given trailing whitespace" do
    assert_nothing_raised do
      KeywordSearch.search("blah  ")
    end
  end
  
  specify "doesn't explode when given multiple whitespace characters in a row" do
    assert_nothing_raised do
      KeywordSearch.search("blah   blah")
    end
  end
end
